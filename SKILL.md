...
### 1. Proxy Detection
Checks EIP-1167 minimal proxy (embedded impl in bytecode), EIP-1967
implementation and beacon storage slots, UUPS via `proxiableUUID()` on the
implementation, OpenZeppelin legacy slot, and `implementation()` getter fallback.
