...
import { buildReport } from "../address-intelligence/scripts/lib/report.mjs";
...
export function createLocalNodeAdapters({
  ...
  buildAddressReport = buildReport,
  ...
  return {
    address: defineAdapter({
      ...
      assess: async (request, context) => {
        ...
        return buildAddressReport(analysis);
      },
    }),
